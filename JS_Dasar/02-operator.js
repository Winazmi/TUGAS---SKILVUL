// / Soal - 01
// / Dibawah ini akan ditampilkan daftar pengeluaran bulan ini beserta gaji yang akan diterima, tugas
// -mu adalah untuk menghitung gaji yang tersisa
...
const total_Pengeluaran = gundam + makan + kost + subscription;

// / Gaji
const gajiPokok = 5000000
const gajiBonus = gajiPokok * 0.1;
const gajiLembur = gajiPokok * 0.05;
const total_Gaji = gajiPokok+gajiBonus+gajiLembur;


const sisaGaji=total_Gaji-total_Pengeluaran;
